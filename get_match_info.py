...
if __name__ == '__main__':
    ...
    checkpoints_path = '/home/lsq/guidegs/gim/weights/gim_dkm_100h.ckpt'
    ...
    root_dir_ = "dataset/ibrnet-llff"
    filenames = os.listdir(root_dir_)
    # for file in filenames:
    #     if file == '.DS_Store':
    #         continue
    file = "yamaha_piano"
    # replace to your own path
    root_dir = os.path.join(root_dir_, file, "images")
    filenames = sorted(os.listdir(root_dir))
    image_dir = os.path.join(root_dir_, file, "images_match")
    ...
    # tanks
    # root_dir = os.path.join(root_dir_, file, "24_views/images")
    # filenames = sorted(os.listdir(root_dir))
    # image_dir = os.path.join(root_dir_, file, "24_views/images_match")
    # os.makedirs(image_dir, exist_ok=True)
    ...
    for i in range(len(filenames)-1):
        ...
        for j in range(i+1, len(filenames)):
            ...
            with warnings.catch_warnings():
                ...
                sparse_matches, mconf = model.sample(dense_matches, dense_certainty, 10000)
            ...
            _, mask = cv2.findFundamentalMat(kpts0.cpu().numpy(),
                                            kpts1.cpu().numpy(),
                                            cv2.USAC_MAGSAC, ransacReprojThreshold=1.5,
                                            confidence=0.99, maxIters=10000)
            mask = mask.ravel() > 0

...
def render_set(model_path, name, iteration, views, gaussians, pipeline, background):
    ...
    cat_path = os.path.join(model_path, name, "ours_{}".format(iteration), "cat")
    ...
    makedirs(cat_path, exist_ok=True)
    ...
    for idx, view in enumerate(tqdm(views, desc="Rendering progress")):
        ...
        concatenated_image = torch.cat([rendering, gt], dim=-1)
        ...
        torchvision.utils.save_image(concatenated_image, os.path.join(cat_path, '{0:05d}'.format(idx) + ".png"))
